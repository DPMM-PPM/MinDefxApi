...
class ilCmiXapiSettingsGUI
{
    ...
    protected function buildForm()
    {
        ...
        if (!$this->object->isSourceTypeExternal()) {
            ...
            $op = new ilRadioOption(
                $DIC->language()->txt('ui_uihk_xmindefxapi_conf_privacy_ident_il_login'),
                ilCmiXapiLrsType::PRIVACY_IDENT_IL_LOGIN
            );
            $op->setInfo($DIC->language()->txt('ui_uihk_xmindefxapi_conf_privacy_ident_il_login_info'));
            $userIdent->addOption($op);
            $op = new ilRadioOption(
