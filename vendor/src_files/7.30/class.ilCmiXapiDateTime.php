...
//        ilObjCmiXapi::log()->debug('format date '.$phpDateTime->format(self::RFC3336_EXTENDED_FIXED_USING_u_INSTEAD_OF_v));
        $newDate=str_replace("3600","",$phpDateTime->format(self::RFC3336_EXTENDED_FIXED_USING_u_INSTEAD_OF_v));
//        ilObjCmiXapi::log()->debug('newformat date '.$newDate);
